      ...
      <div className="max-w-[1440px] mx-auto text-center">
        <div className="max-w-[1059px] mx-auto">
          ...
          <div className="flex flex-wrap justify-center items-center gap-3 mb-6 text-sm sm:text-base text-gray-300">
            ...
            <span className="text-center">Trusted by 300+ delighted customers</span>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button className="bg-white text-black font-semibold px-6 py-3 rounded-lg hover:bg-black hover:text-white border border-transparent hover:border-white transition duration-300">
              Get a Free Automation Audit
            </button>
            <button className="border border-white text-white px-6 py-3 rounded-lg hover:bg-white hover:text-black transition duration-300">
              Explore Use Cases
            </button>
          </div>
        </div>
